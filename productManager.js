// Función constructora que crea un array vacío en el cual se guardan los objetos de productos a instanciar.
  ...
  // Función que agrega los objetos de productos al array, validando el cumplimiento de las condiciones del desafío.
      addProduct = (product) => {
          ...
          if (!product.title ||
              ...
              !product.code ||
              !product.stock) {
              return `Error al intentar agregar el producto: "${product.title}". Es necesario completar todos los campos del producto para que pueda ser agregado.`
          }
          ...
          if (repeatedCode) {
              return `Error al intentar agregar el producto: "${product.title}". No pudo ser agregado porque ya existe un producto con el código ingresado.`
          }
